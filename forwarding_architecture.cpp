...
public:
    ...
    HazardDetectionUnit HazardDetect_Unit = HazardDetectionUnit();
    ...
    BranchForwardingUnit BranchForward_Unit = BranchForwardingUnit();
    ...
    ALUForwardingUnit ALUForwarding_Unit = ALUForwardingUnit();
    MUX4x1 Input1Forwarding_MUX = MUX4x1(32);
    MUX4x1 Input2Forwarding_MUX = MUX4x1(32);
